...
<div class="article-sub-section">
    <center>
        <img src="{{ blog__assets }}/blog/other/NGINX-header-show.png" alt="Image mettant en évidence l'entete Server envoyé par le serveur NGINX" class="article-sub-img" />
        <i>L'entête “server” par défaut de Nginx</i>
    </center>
</div>
...
<div class="article-sub-section">
    <center>
        <img src="{{ blog__assets }}/blog/other/NGINX-repo-mercurial.png" alt="Image montrant les modules disponible pour NGINX Alpine" class="article-sub-img" />
        <i>La liste des modules disponible pour NGINX Alpine en version 1.25</i>
    </center>
</div>
