...
description: "On regarde comment supprimer l'en-tete \"Server\" des réponses HTTP de NGINX"
pubDate: 2024-04-25
author: 'Bastien BYRA'
...
![Image mettant en évidence l'entete "Server" envoyé par le serveur NGINX](../../assets/2024-04-25-Comment-modifier-ou-retirer-le-header-server-de-nginx/NGINX-header-show.png)
...
![Image montrant les modules disponible pour NGINX Alpine](../../assets/2024-04-25-Comment-modifier-ou-retirer-le-header-server-de-nginx/NGINX-repo-mercurial.png)
