...
description: "Je vous présente Grype et Trivy, deux outils permettant de scanner des images Docker afin de s'assurer qu'aucune faille au niveau des dépendances ne soit présente, avec une implémentation dans une CI/CD."
pubDate: 2025-03-22
author: 'Bastien BYRA'
tags: ["Guide", "Sécurité", "Conteneur", "Docker"]
heroImage: "../../assets/Maintenir-ses-dependances-et-conteneurs-securises-et-a-jour-avec-grype-et-trivy/maintenir-ses-dependances-et-conteneurs-securises-et-a-jour-avec-grype-et-trivy.png"
---
...
* [Grype : Simplicité et rapidité](#grype--simplicité-et-rapidité)
  * [Installation](#installation)
  * [Utiliser Grype](#utiliser-grype)
  * [Implémenter Grype dans sa CI/CD](#implémenter-grype-dans-sa-cicd)
* [Trivy, le plus ancien, et populaire](#trivy-le-plus-ancien-et-populaire)
  * [Installation](#installation-1)
  * [Utiliser Trivy](#utiliser-trivy)
  * [Implémenter Trivy dans sa CI/CD](#implémenter-trivy-dans-sa-cicd)
* [Lequel devrais-je choisir ?](#lequel-devrais-je-choisir-)
* [Comment être sure de sure que mon application est prête ?](#comment-être-sure-de-sure-que-mon-application-est-prête-)
...
## Le choix du scanneur ; Grype ou Trivy
...
### Implémenter Grype dans sa CI/CD
...
## Trivy, le plus ancien, et populaire
...
### Implémenter Trivy dans sa CI/CD
...
## Comment être sure de sure que mon application est prête ?
