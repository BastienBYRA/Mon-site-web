...
description: "Présentation de Nix, un gestionnaire de paquet"
pubDate: 2024-07-21
author: 'Bastien BYRA'
heroImage: "../../assets/Nix-un-gestionnaire-de-paquet-et-plus-encore/nix-main.png"
tags: ["Guide", "Nix"]
---
...
* [C’est quoi Nix {#cest-quoi-nix}](#cest-quoi-nix-cest-quoi-nix)
* [Comment installer Nix {#comment-installer-nix}](#comment-installer-nix-comment-installer-nix)    
  * [Linux et WSL2 {#linux-et-wsl2}](#linux-et-wsl2-linux-et-wsl2)
  * [MacOS {#macos}](#macos-macos)
* [Exemple : Environnement de développement : NodeJS - Java / Angular {#environnement-de-développement-nodejs-java-angular}](#exemple--environnement-de-développement--nodejs---java--angular-environnement-de-développement-nodejs-java-angular)
* [NixOS {#nixos}](#nixos-nixos)
  * [Installer et configurer des outils {#installer-et-configurer-des-outils}](#installer-et-configurer-des-outils-installer-et-configurer-des-outils)
* [Aquaproj, asdf, mise, devenv… {#aquaproj-asdf-mise-devenv}](#aquaproj-asdf-mise-devenv-aquaproj-asdf-mise-devenv)
...
## Exemple : Environnement de développement : NodeJS - Java / Angular
...
### Installer et configurer des outils
