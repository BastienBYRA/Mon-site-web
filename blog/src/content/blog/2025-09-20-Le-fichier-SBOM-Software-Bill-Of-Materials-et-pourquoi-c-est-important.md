...
description: "Présentation des SBOM (Software Bill Of Materials) : Son importance dans l'analyse des vulnérabilités, l'identification des licences et la sécurité de vos logiciels"
pubDate: 2025-09-20
author: 'Bastien BYRA'
tags: ["Sécurité", "SBOM"]
heroImage: "../../assets/Le-fichier-SBOM-Software-Bill-Of-Materials-et-pourquoi-c-est-important/le-fichier-SBOM-Software-Bill-Of-Materials-et-pourquoi-c-est-important.png"
---

## Table des matières

* [Introduction](#introduction)
* [Se tenir au courant des vulnérabilités en temps réel](#se-tenir-au-courant-des-vulnérabilités-en-temps-réel)
* [L'enjeu des licences](#lenjeu-des-licences)
* [Être informé des nouvelles mises à jour des dépendances](#être-informé-des-nouvelles-mises-à-jour-des-dépendances)
* [Le Cyber Resilience Act](#le-cyber-resilience-act)
* [Format, standard et génération](#format-standard-et-génération)
  * [Les formats de fichier SBOM](#les-formats-de-fichier-sbom)
  * [Comment générer un fichier SBOM](#comment-générer-un-fichier-sbom)
...
## Se tenir au courant des vulnérabilités en temps réel
...
![Image montrant un arbre de dépendance typique d'une dépendance informatique]("../../assets/Le-fichier-SBOM-Software-Bill-Of-Materials-et-pourquoi-c-est-important/dependency-tree-software.png")
...
## Être informé des nouvelles mises à jour des dépendances
...
## Format, standard et génération
### Les formats de fichier SBOM
...
### Comment générer un fichier SBOM
