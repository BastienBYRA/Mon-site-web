...
pubDate: 2025-02-22
author: 'Bastien BYRA'
tags: ["Guide", "Kubernetes", "Docker", "Migration technologique"]
heroImage: "../../assets/Migrer-de-docker-compose-vers-kubernetes-avec-kompose/migrer-de-docker-compose-vers-kubernetes-avec-kompose.png"
---

## Table des matières

* [Introduction](#introduction-introduction)
* [Kompose](#kompose-kompose)
* [Labels, un moyen d’aller plus loin dans la configuration de vos sorties Kubernetes](#labels-un-moyen-daller-plus-loin-dans-la-configuration-de-vos-sorties-kubernetes-labels-un-moyen-daller-plus-loin-dans-la-configuration-de-vos-sorties-kubernetes)
...
## Labels, un moyen d’aller plus loin dans la configuration de vos sorties Kubernetes
